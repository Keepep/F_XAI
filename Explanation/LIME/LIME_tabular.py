...
class lime_tabular():
    def __init__(self,
        ...
        self.base = LIME_base.lime_base(kernel_fn, verbose, random_state=self.random_state)
    ...
    def explain_instance(self,
        ...
        #distance between instance x (scaled_data[0]) and sampled data
        ...
        #ret_exp contains all of information to produce a result
        ...
        if self.mode == "classification":
            ...
            #get probability result of instance x
            ret_exp.predict_proba = yss[0]
            if top_labels:

                #get label of top probability
    ...
    def __data_inverse(self,
        ...
        if self.discretizer is None:
            ...
            #sampling from normal distribution ~ N(0,1)
        ...
        inverse[0] = data_row
        #if cateogorical_features are empty, inverse==data
        return data, inverse
